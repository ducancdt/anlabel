...
LicenseFile=..\LICENSE
OutputDir=..\releases\ANLAbel-v0.265
OutputBaseFilename=ANLAbel-v0.265-Setup-x64
...
[Files]
Source: "..\publish_out\release-x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
