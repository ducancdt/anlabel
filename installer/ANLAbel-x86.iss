; ANLAbel Installer Script for Inno Setup (x86)
; Created by Duc An | ducancdt@gmail.com

[Setup]
AppId={{A8B2C3D4-E5F6-4789-ABCD-EF0123456790}
...
OutputDir=..\releases
OutputBaseFilename=ANLAbel-v0.042-Setup-x86
...
[Files]
Source: "..\TestOutput\ANLABEL-build-x86\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
