...
{
    public const string Version = "ANL-industrial-subset-2026.08";
    ...
    [
        ...
        new("17", Gs1AiBoundaryKind.PredefinedLength), new("21", Gs1AiBoundaryKind.SeparatorRequired), new("30", Gs1AiBoundaryKind.SeparatorRequired),
        new("37", Gs1AiBoundaryKind.SeparatorRequired), new("240", Gs1AiBoundaryKind.SeparatorRequired), new("241", Gs1AiBoundaryKind.SeparatorRequired),
        ...
        new("424", Gs1AiBoundaryKind.SeparatorRequired), new("425", Gs1AiBoundaryKind.SeparatorRequired), new("426", Gs1AiBoundaryKind.SeparatorRequired),
        ...
        new("7003", Gs1AiBoundaryKind.SeparatorRequired), new("9x", Gs1AiBoundaryKind.SeparatorRequired)
    ];
