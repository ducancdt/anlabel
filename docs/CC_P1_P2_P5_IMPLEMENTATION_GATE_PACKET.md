...
**P1 Operations Overview owner packet:** [`CC_P1_OPERATIONS_OVERVIEW_UI_DECISION_PACKET.md`](CC_P1_OPERATIONS_OVERVIEW_UI_DECISION_PACKET.md)
...
**P5 History owner packet:** [`CC_P5_HISTORY_REPRINT_UI_DECISION_PACKET.md`](CC_P5_HISTORY_REPRINT_UI_DECISION_PACKET.md)
...
| D6. P5 History/reprint | History uses state/operation provenance with linked CSV detail/export; the concrete boundary is recorded in [`CC_P5_HISTORY_REPRINT_UI_DECISION_PACKET.md`](CC_P5_HISTORY_REPRINT_UI_DECISION_PACKET.md). Print Center owns reconcile, acknowledge, void, request/approve reprint, guarded preview, dispatch and support export. No row/card dispatch shortcut or second action stack. | Approve History host/detail owner, reprint eligibility copy, local timezone/privacy and corrupt-tail handling. |
